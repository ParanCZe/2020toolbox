    ...
    if(!$('#tool-upscaler')){const anchor=document.querySelector('.tool-view');if(!anchor)return;const v=document.createElement('div');v.id='tool-upscaler';v.className='tool-view';v.innerHTML=`
      ...
      <div class="ups-grid">
        <section class="ups-panel"><h2>VSTUP A NASTAVENÍ</h2>
          ...
          <div id="ups-vosr-note" class="ups-vosr-note" hidden><b>VOSR 2.0 · generativní rekonstrukce celé scény</b><br>Obnovuje objekty, lidi, hrany, materiály a textury v jednom passu. Vyžaduje spuštěný <code>UpscaleBridge\\run_bridge.bat</code> a NVIDIA GPU.</div>
