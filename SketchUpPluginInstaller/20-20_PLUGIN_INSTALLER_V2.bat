...
set "PS1=%HELPER_DIR%\install_plugin_v2.ps1"
set "PS1_URL=https://raw.githubusercontent.com/ParanCZe/2020toolbox/main/SketchUpPluginInstaller/install_plugin_v2.ps1"
