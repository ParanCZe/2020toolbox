(()=>{
  ...
  function showWhatsNew(){
    ...
    overlay.innerHTML=`<div id="toolbox-release-window" role="dialog" aria-modal="true" aria-labelledby="toolbox-release-title"><h2 id="toolbox-release-title">Co je nového — ${RELEASE}</h2><p>Aktualizace 20-20 TOOLBOX.</p><ul><li>Opravené zarovnání řádků v Cenové nabídce.</li><li>Sloupec Rozsah služby je nyní skutečně odstraněný i z vykreslených řádků.</li><li>Hodiny, Sazba Kč/h a Cena bez DPH jsou posunuté o jeden sloupec doleva pod správné hlavičky.</li></ul><button type="button" id="toolbox-release-ok">Rozumím</button></div>`;
