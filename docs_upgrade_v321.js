(()=>{
  ...
  function loadReleaseUI(){loadScriptOnce('release_ui_v341.js?v=356','release-ui-v341')}
  ...
  function loadPricingLayout(){loadScriptOnce('pricing_layout_v353.js?v=356','pricing-layout-v353')}
