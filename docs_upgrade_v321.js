(()=>{
  ...
  function loadUpscaler(){loadScriptOnce('upscaler_v359.js?v=377','upscaler-v359')}
  ...
  function loadPricingOffer(){loadScriptOnce('pricing_offer_v345.js?v=350','pricing-offer-v349')}
