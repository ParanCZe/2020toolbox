...
module TwentyTwenty
  module TextureLibrary
    ...
    def create_command
      ...
      @cmd_open.tooltip='20-20 Texture Library – vlastní textury, SIKO obklady, EGGER dekory, RAL a NCS'
      @cmd_open.status_bar_text='Otevře knihovnu textur, SIKO obkladů, EGGER dekorů a barev pro rychlé mapování klikáním na plochy.'
