    ...
    foreach ($cert in $store.Certificates) {
      ...
      try {
        ...
        $items += [pscustomobject]@{
          ...
          store_location = $location.ToString()
          store_name = 'My'
        }
      } finally {
...
@($items | Sort-Object supported -Descending, valid_to -Descending) | ConvertTo-Json -Compress -Depth 4
"""
...
if ($thumb -notmatch '^[0-9A-F]{40,128}
...
throw 'Vybraný certifikát nebyl nalezen v CurrentUser ani LocalMachine úložišti.'
"""
